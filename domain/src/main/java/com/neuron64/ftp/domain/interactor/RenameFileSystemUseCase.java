...
public class RenameFileSystemUseCase extends RenameDocumentUseCase<RenameFileParams>{

    @Inject
    public RenameFileSystemUseCase(BaseSchedulerProvider schedulerProvider, FileSystemRepository repository) {
