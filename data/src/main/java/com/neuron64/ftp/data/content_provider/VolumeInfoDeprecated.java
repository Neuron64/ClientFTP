...
@Deprecated
public class VolumeInfoDeprecated {
    ...
    public VolumeInfoDeprecated(String id, int storageId, File path, File visiblePath, String description, boolean primary, boolean removable, boolean emulated, long mtpReserveSize, boolean allowMassStorage, long maxFileSize, String fsUuid, String mSstate) {
        this.id = id;
    ...
    public VolumeInfoDeprecated(){*/
/*Empty*//*
}

    public File getVisiblePath() {
        return visiblePath;
    }

    public void setVisiblePath(File visiblePath) {
        this.visiblePath = visiblePath;
    }
