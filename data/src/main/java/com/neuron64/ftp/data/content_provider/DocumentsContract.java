...
import static com.neuron64.ftp.data.content_provider.Preconditions.checkArgument;
import static com.neuron64.ftp.data.content_provider.Preconditions.checkCollectionElementsNotNull;
import static com.neuron64.ftp.data.content_provider.Preconditions.checkCollectionNotEmpty;

/**
 * Defines the contract between a documents provider and the platform.
 * <p>
 * To create a document provider, extend {@link }, which
...
public final class DocumentsContract {
    ...
    public final static class Document {
         ...
         * by a {@link }, and should be treated as an opaque
         ...
         *
         * @see #COLUMN_FLAGS
         * @see DocumentsContract#(PackageManager, Uri, Bundle)
         */
    ...
    public final static class Root {
         ...
         * {@link }, and should be treated as an opaque value
    ...
    public static Bitmap getDocumentThumbnail(
        ...
        try {
            ...
            UtilsContentProviderClient.releaseQuietly(client);
        }
    }
    /** {@hide} */
    public static Bitmap getDocumentThumbnail(
